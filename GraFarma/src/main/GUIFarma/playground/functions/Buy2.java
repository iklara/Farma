            ...
            for (AnimalLabel2 al2 : hl2) {
                ...
                if (buyCounter == hl2.size() && herd2.size() > herd2.indexOf(hl2) + 1) {
                    ...
                    buttonBuy2.addActionListener(action -> {
                        ...
                        if (hl2.get(hl2.size() - 1).isFree2() == false && herd2.get(herd2.indexOf(hl2) + 1).get(herd2.get(herd2.indexOf(hl2) + 1).size() - 1).isFree2() == true) {
                            switch (herd2.indexOf(hl2) + 1) {
                                case 1:
                                    for (int i = 0; i < sheepsRow2.size(); i++) {
                                        System.out.println("Owca");
                                        if (sheepsRow2.get(i).isFree2() == true) {
                                ...
                                case 2:
                                    ...
                                    for (int i = 0; i < pigsRow2.size(); i++) {
                                        if (pigsRow2.get(i).isFree2() == true) {
                                ...
                                case 4:
                                    for (int i = 0; i < horseRow2.size(); i++) {
                                        if (horseRow2.get(i).isFree2() == true) {
                        ...
                        } else if (herd2.get(herd2.indexOf(hl2) + 1).get(herd2.get(herd2.indexOf(hl2) + 1).size() - 1).isFree2() == false) {
                            JOptionPane.showMessageDialog(this, "chcesz kupić a nie masz miejsca dla swojego zwierzaka");
                        } else if (hl2.get(hl2.size() - 1).isFree2() == true) {
