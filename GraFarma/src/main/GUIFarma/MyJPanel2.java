	...
	public class MyJPanel2 extends JPanel{
		...
		public Dimension getPreferredSize() {
			...
			public MyJPanel2() {
				...
				JButton button2 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button2.setBounds(100, 150, 50, 50);
				button2.isBackgroundSet();
				add(button2);
				JButton button3 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button3.setBounds(150, 150, 50, 50);
				button3.isBackgroundSet();
				add(button3);
				JButton button4= new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button4.setBounds(200, 150, 50, 50);
				button4.isBackgroundSet();
				add(button4);
				JButton button5 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button5.setBounds(250, 150, 50, 50);
				button5.isBackgroundSet();
				add(button5);
				JButton button5a = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
...
//				f.setVisible(true);       
				...
				JButton button6 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button6.setBounds(500, 150, 50, 50);
				button6.isBackgroundSet();
				add(button6);
				JButton button7 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button7.setBounds(550, 150, 50, 50);
				button7.isBackgroundSet();
				add(button7);
				JButton button8 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button8.setBounds(600, 150, 50, 50);
				button8.isBackgroundSet();
				add(button8);
				JButton button9 = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button9.setBounds(650, 150, 50, 50);
				button9.isBackgroundSet();
				add(button9);
				JButton button9a = new JButton(new ImageIcon("src\\main\\resources\\rabbitSmall.jpg"));
				button9a.setBounds(700, 150, 50, 50);
				button9a.isBackgroundSet();
				add(button9a);
				

				JButton button10 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button10.setBounds(125, 200, 50, 50);
				button10.isBackgroundSet();
				add(button10);
				
				JButton button11 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button11.setBounds(175, 200, 50, 50);
				button11.isBackgroundSet();
				add(button11);
				
				JButton button12 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button12.setBounds(225, 200, 50, 50);
				button12.isBackgroundSet();
				add(button12);
				
				JButton button13 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button13.setBounds(275, 200, 50, 50);
				button13.isBackgroundSet();
				add(button13);
				
				
				JButton button14 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button14.setBounds(525, 200, 50, 50);
				button14.isBackgroundSet();
				add(button14);
				JButton button15 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				
				button15.setBounds(575, 200, 50, 50);
				button15.isBackgroundSet();
				add(button15);
				JButton button16 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				button16.setBounds(625, 200, 50, 50);
				button16.isBackgroundSet();
				add(button16);
				JButton button17 = new JButton(new ImageIcon("src\\main\\resources\\sheepSmall.jpg"));
				...
				JButton button18 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button18.setBounds(150, 250, 50, 50);
				button18.isBackgroundSet();
				add(button18);
				JButton button19 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button19.setBounds(200, 250, 50, 50);
				button19.isBackgroundSet();
				add(button19);
				JButton button20 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button20.setBounds(250, 250, 50, 50);
				button20.isBackgroundSet();
				add(button20);
				
							
				JButton button23 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button23.setBounds(550, 250, 50, 50);
				button23.isBackgroundSet();
				add(button23);
				
				JButton button24 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button24.setBounds(600, 250, 50, 50);
				button24.isBackgroundSet();
				add(button24);
				JButton button25 = new JButton(new ImageIcon("src\\main\\resources\\swinkaSmall.png"));
				button25.setBounds(650, 250, 50, 50);
				button25.isBackgroundSet();
				add(button25);
					
			
				JButton button27 = new JButton(new ImageIcon("src\\main\\resources\\cowSmall.png"));
				button27.setBounds(175, 300, 50, 50);
				button27.isBackgroundSet();
				add(button27);
				
				JButton button28 = new JButton(new ImageIcon("src\\main\\resources\\cowSmall.png"));
				button28.setBounds(225, 300, 50, 50);
				button28.isBackgroundSet();
				add(button28);
			
							
				JButton button31 = new JButton(new ImageIcon("src\\main\\resources\\cowSmall.png"));
				button31.setBounds(575, 300, 50, 50);
				button31.isBackgroundSet();
				add(button31);
				JButton button32 = new JButton(new ImageIcon("src\\main\\resources\\cowSmall.png"));
				...
				JButton button36 = new JButton(new ImageIcon("src\\main\\resources\\funHSmall.jpg"));
				button36.setBounds(200, 350, 50, 50);
				button36.isBackgroundSet();
				add(button36);
				
						
				JButton button40 = new JButton(new ImageIcon("src\\main\\resources\\funHSmall.jpg"));
				button40.setBounds(600, 350, 50, 50);
				button40.isBackgroundSet();
				add(button40);
		
		
				JButton button42= new JButton(new ImageIcon("src\\main\\resources\\dogSSmall.png"));
				button42.setBounds(100, 450, 100, 50);
				button42.isBackgroundSet(); // bloean if true zmienia kolor
				add(button42);
				JButton button43= new JButton(new ImageIcon("src\\main\\resources\\bigDogSmall.png"));
				button43.setBounds(200, 450, 100, 50);
				button43.isBackgroundSet();
				add(button43);
				
				JButton button44= new JButton(new ImageIcon("src\\main\\resources\\dogSSmall.png"));
				button44.setBounds(500, 450, 100, 50);
				button44.isBackgroundSet();
				add(button44);
				JButton button45= new JButton(new ImageIcon("src\\main\\resources\\bigDogSmall.png"));
				...
				add(etykieta15);
				JButton button46= new JButton(new ImageIcon("src\\main\\resources\\foxS.png"));
				...
				add(etykieta16);
				JButton button47= new JButton(new ImageIcon("src\\main\\resources\\foxS.png"));
				...
				add(etykieta17);
				JButton button48= new JButton(new ImageIcon("src\\main\\resources\\WS.png"));
				...
				JButton button49= new JButton(new ImageIcon("src\\main\\resources\\WS.png"));
